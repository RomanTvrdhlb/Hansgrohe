...
const { noveltiesSlider, programBox, newsInner } = vars;

if(noveltiesSlider){
const noveltiesSwiper = new Swiper('.novelties-slider__inner', {
  slidesPerView: 1,
  spaceBetween: 0,
  observer: true,
  observeParents: true,
  ...
  navigation: {
    nextEl: '.novelties-slider__nav-next',
    prevEl: '.novelties-slider__nav-prev',
  },
