...
/* harmony import */ var _components_replaceEl__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/replaceEl */ "./source/js/components/replaceEl.js");
...
if (noveltiesSlider) {
  ...
  const noveltiesSwiper = new (_vendor_swiper__WEBPACK_IMPORTED_MODULE_0___default())(noveltiesContainer, {
    slidesPerView: 1,
    spaceBetween: 0,
    observer: true,
    observeParents: true,
...
if (examplesSlider) {
  ...
  pagination.setAttribute('data-active', '1');
  const examlesSwiper = new (_vendor_swiper__WEBPACK_IMPORTED_MODULE_0___default())(examlesContainer, {
    slidesPerView: 1,
    spaceBetween: 10,
    observer: true,
    observeParents: true,
...
if (defaultSliders) {
  defaultSliders.map(function (defaultSlider) {
    ...
    pagination.setAttribute('data-active', '1');
    const defaultSwiper = new (_vendor_swiper__WEBPACK_IMPORTED_MODULE_0___default())(defaultContainer, {
      slidesPerView: 1,
      spaceBetween: 10,
      observer: true,
      observeParents: true,
